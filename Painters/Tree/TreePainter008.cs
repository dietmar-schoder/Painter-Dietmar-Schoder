...
{
    public class TreePainter008 : IPainter
    {
        ...
        public void DrawOnCanvas(ICanvas canvas)
        {
            ...
            for (var j = 0; j < 10; j++)
            {
                var startVector = new Vector(0, -_branchLength).Rotated(j * 0.5);
